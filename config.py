...
STATS_VID_URL = "https://files.catbox.moe/qibmue.mp4"
...
AYU = [
    "💞 ғɪɴᴅɪɴɢ ʟᴏᴠᴇ ғʀᴇǫᴜᴇɴᴄʏ... ᴍʏ ʜᴇᴀʀᴛ ɪѕ ᴛᴜɴɪɴɢ ᴛᴏ ʏᴏᴜ 💫",
    "🎧 ᴍᴇʟᴏᴅʏ ɪɴ ᴍᴏᴛɪᴏɴ... ʙᴀʙʏ ʏᴏᴜʀ ʙᴇᴀᴛ ɪѕ ᴍʏ ʀʜʏᴛʜᴍ 💋",
    "🌹 ᴠɪʙᴇ ᴅᴇᴛᴇᴄᴛᴇᴅ... ᴍʏ ʜᴇᴀʀᴛ ᴅᴀɴᴄɪɴɢ ᴡɪᴛʜ ʏᴏᴜ 🎶",
    "💘 ʟᴏᴀᴅɪɴɢ ʜᴇᴀʀᴛʙᴇᴀᴛ... ᴍʏ ʙᴀʙʏ ɪѕ ᴛʜᴇ ʀʜʏᴍᴇ 🌸",
    "💫 ᴄᴏɴɴᴇᴄᴛɪɴɢ ᴛᴏ ʏᴏᴜʀ ѕᴏᴜʟ... ᴍʏ ʟᴏᴠᴇ ғʀᴇǫᴜᴇɴᴄʏ ❤️",
    "💖 ʙᴀʙʏ, ʏᴏᴜʀ ᴠɪʙᴇ ɪѕ ᴍʏ ғᴀᴠᴏᴜʀɪᴛᴇ ѕᴏɴɢ 🌷",
    "🎵 ʙᴀʙᴇ, ʏᴏᴜ ᴀʀᴇ ᴛʜᴇ ʙᴇᴀᴛ ɪɴ ᴍʏ ᴍᴇʟᴏᴅʏ 💞",
    "💋 ʟᴏᴀᴅɪɴɢ ᴅʀᴇᴀᴍ ᴍᴏᴅᴇ... ʜᴇᴀʀᴛ ᴀʟɪɢɴᴇᴅ ᴡɪᴛʜ ʏᴏᴜ 💫",
    "🌸 ᴍʏ ʜᴇᴀʀᴛ ɪѕ ʙᴜғғᴇʀɪɴɢ ʏᴏᴜʀ ʟᴏᴠᴇ 🎧",
    "❤️‍🔥 ғɪɴᴅɪɴɢ ʏᴏᴜʀ ᴡᴀᴠᴇѕ, ᴍʏ ᴀɴɢᴇʟ 💋",
    "💞 ʙᴀʙʏ, ʏᴏᴜʀ ʜᴇᴀʀᴛ ɪѕ ᴍʏ ᴘʟᴀʏʟɪѕᴛ 🎶",
    "🌷 ᴅᴇᴛᴇᴄᴛɪɴɢ ʟᴏᴠᴇ ѕɪɢɴᴀʟ... ʙᴀʙᴇ ʏᴏᴜ’ʀᴇ ᴏɴ ʟᴏᴏᴘ 💘",
    "🎶 ʜᴇᴀʀᴛ ʀᴇᴘʟᴀʏɪɴɢ ʏᴏᴜʀ ɴᴀᴍᴇ... ᴀʟʟ ɴɪɢʜᴛ 💞",
    "💓 ᴍʏ ʟᴏᴠᴇ, ʏᴏᴜʀ ʙᴇᴀᴛ ɪѕ ᴍʏ ғᴀᴠᴏᴜʀɪᴛᴇ ʀᴇᴍɪx 🌹",
    "💫 ʙᴀʙʏ ʏᴏᴜ’ʀᴇ ᴛʜᴇ ʀʜʏᴛʜᴍ ɪɴ ᴍʏ ʜᴇᴀʀᴛ 💖"
]
